...
PATH="$HOME/.local/src/build-rust/install_dir/nightly/bin:$HOME/.local/bin:/bin:/sbin:/usr/bin:/usr/sbin:/usr/X11R6/bin:/usr/local/bin:/usr/local/sbin:/usr/local/jdk-11/bin"
