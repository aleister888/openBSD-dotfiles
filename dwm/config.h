...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_n,      spawn,            SHCMD("sndioctl output.mute=!; pkill -USR1 dwmblocks") },
	{ MODKEY|ControlMask,           XK_m,      spawn,            SHCMD("sndioctl output.mute=!; pkill -USR1 dwmblocks") },
	// Volumen al 100%/50%
